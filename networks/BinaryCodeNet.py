...
import torch
from .aspp import ASPP, ASPP_50, ASPP_non_binary_ablationstudy, ASPP_Efficientnet, ASPP_Efficientnet_upsampled,ASPP_Efficientnetv2
from .resnet import ResNet50_OS8, ResNet34_OS8
from .efficientnet import efficientnet_intermediate_out,efficientnet_upsampled
...
class BinaryCodeLoss(nn.Module):
    ...
    def forward(self, pred_binary_code, pred_mask, groundtruth_code, train=True):
