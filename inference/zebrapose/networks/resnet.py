...
class ResNet_BasicBlock_OS16(nn.Module):
    def __init__(self, num_layers):
        ...
        if num_layers == 18:
            ...
            # load pretrained model:
            #resnet.load_state_dict(torch.load("/home/heyuxing/hyx_projects/zebrapose_custom_bop_v2/other/pretrained_models/resnet34-333f7ec4.pth"))
            # remove fully connected layer, avg pool and layer5:
            self.resnet = nn.Sequential(*list(resnet.children())[:-3])
...
class ResNet_BasicBlock_OS8(nn.Module):
    def __init__(self, num_layers, concat_decoder):
        ...
        if num_layers == 18:
            ...
            #filename = os.path.join(dirname, '/home/heyuxing/hyx_projects/zebrapose_custom_bop_v2/other/pretrained_models/resnet34-333f7ec4.pth')
